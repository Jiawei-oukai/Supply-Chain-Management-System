...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-white w3-card" id="myNavbar">
			...
			<div class="w3-right"> 
				<a href="./ManufactureProcurementManagerViewOrder" class="w3-bar-item w3-button"><i class="fa fa-eye"></i>MANAGE ORDER</a> 
		...
		<div class="w3-display-top w3-text-white" style="padding: 48px">
			<p>
				<a
					...
					Welcome! You can buy materials for your company!</a>
			</p>
		</div>

		<div class="w3-display-left w3-text-black" style="padding: 48px">
			<p>
				<a href="./ManufactureProcurementManagerViewMaterial" class="w3-button w3-grey"><i class="fa fa-arrow-circle-right">Buy Materials</i></a>
			</p>
