...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-white w3-card" id="myNavbar">
			...
			<div class="w3-right">
				<a href="./ManufactureSupplyManagerProductInventory" class="w3-bar-item w3-button"><i class="fa fa-user"></i>PRODUCT INVENTORY</a> 
				<a href="./ManufactureSupplyManagerViewDistributorOrder" class="w3-bar-item w3-button"><i class="fa fa-eye"></i>MANAGE ORDER</a> 
		...
		<div class="w3-display-top w3-text-white" style="padding: 48px">
			<p>
				<a
					...
					Welcome! You can manage orders</a>
			</p>
		</div>
