...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-white w3-card" id="myNavbar">
			...
			<div class="w3-right">
				<a href="./ManagerViewOrder" class="w3-bar-item w3-button"><i class="fa fa-eye"></i>MANAGE SUPPLY CHAIN ISSUES</a> 
		...
		<div class="w3-display-top w3-text-white" style="padding: 48px">
			<p>
				<a
					...
					Welcome! You can add supply chain issues for your company!</a>
			</p>
		</div>

		<div class="w3-display-left w3-text-black" style="padding: 48px">
			<p>
				<a href="./SupplierPlantManagerAddIssue" class="w3-button w3-grey"><i class="fa fa-arrow-circle-right">Add Supply Chain Issue</i></a>
			</p>
